...
<script>
import ModalPassword from "~/system/modeler/components/common/modal/ModalPassword";
...
import ComboLocale from "~/system/modeler/components/common/combo/ComboLocale";
...
export default {
	...
	setup(_, { emit }) {
		...
		async function setUserInfo() {
			...
			await modifyList(TABLE.USER_INFO, [config], "", false);
